...
int main()
{
	...
	//WHAT CUSTOMER WANTS TO BUY AND LISTING THE PRODUCTS AVAILABLE
	cout << "Please what do you want to buy\n"<<endl;
	cout << "We have the following products in stock\n"<<endl;
	cout << "1.Printer = 650\n"<<endl;
	cout << "2.Phone   = 350\n"<<endl;
	cout << "3.Table   = 95\n"<<endl;
	...
	//QUANTITY OF ITEM THE CUSTOMER WANTS TO BUY
	cout << "Please how many of the item do you want to buy"<<endl;
	cin >> quantity;
	cout<<endl;
	...
	}else if(buy_item=="phone" || buy_item=="Phone" || buy_item=="PHONE"){
